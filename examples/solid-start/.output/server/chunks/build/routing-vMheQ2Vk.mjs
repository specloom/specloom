import { createContext, createSignal, createMemo, createRenderEffect, on, useContext, runWithOwner, getOwner, startTransition, resetErrorBoundaries, batch, untrack, createComponent } from 'solid-js';
...
function Ue(t, e, n, s = {}) {
  ...
  }, [v, C] = createSignal(r().value), [L, ne] = createSignal(r().state), S = Fe(v, L, a.queryWrapper), O = [], U = createSignal(isServer ? ce() : []), z = createMemo(() => typeof s.transformUrl == "function" ? I(e(), s.transformUrl(S.pathname)) : I(e(), S.pathname)), H = () => {
    const i = z(), u = {};
  ...
  function ie(i, u) {
    ...
    for (let F in g) {
      ...
      const { preload: b } = x;
      u && b && runWithOwner(n(), () => b({ params: _, location: { pathname: i.pathname, search: i.search, hash: i.hash, query: V(i), state: null, key: "" }, intent: "preload" }));
    }
    R = P;
  }
  function ce() {
...
export { $e as $, Be as B, Ce as C, De as D, E, Ie as I, Me as M, Oe as O, Q, Ue as U, We as W, I as a, ee as e, ge as g, qe as q, ve as v, ze as z };
//# sourceMappingURL=routing-vMheQ2Vk.mjs.map
