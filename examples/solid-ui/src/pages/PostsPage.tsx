...
import { postsListVM, postsShowVM, postsFormVM } from "../data";
...
export function PostsPage() {
  ...
  const handleFormSubmit = () => {
    console.log("Posts form submitted");
    setCurrentView("list");
  };
  ...
  return (
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-gray-900">投稿管理</h1>
