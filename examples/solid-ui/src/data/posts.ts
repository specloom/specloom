...
export const postsData = [
  { id: "1", title: "SolidJSの始め方", slug: "getting-started-solidjs", author: "田中太郎", category: "tech", published: true, publishedAt: "2024-11-15", views: 1250 },
...
export const postsShowVM: ShowViewModel = {
  ...
  id: "1",
  fields: [
    { name: "title", label: "タイトル", kind: "text", value: "SolidJSの始め方" },
    { name: "slug", label: "スラッグ", kind: "text", value: "getting-started-solidjs" },
...
export const postsFormVM: FormViewModel = {
  ...
  id: "1",
  fields: [
    { name: "title", label: "タイトル", kind: "text", value: "SolidJSの始め方", required: true, readonly: false, errors: [], placeholder: "記事タイトル" },
    { name: "slug", label: "スラッグ", kind: "text", value: "getting-started-solidjs", required: true, readonly: false, errors: [], hint: "URLに使用されます（英数字とハイフンのみ）" },
    { name: "category", label: "カテゴリ", kind: "enum", value: "tech", required: true, readonly: false, errors: [], options: categoryOptions },
    { name: "content", label: "本文", kind: "textarea", value: "# SolidJSとは\n\nSolidJSは...", required: true, readonly: false, errors: [], placeholder: "Markdown形式で入力" },
